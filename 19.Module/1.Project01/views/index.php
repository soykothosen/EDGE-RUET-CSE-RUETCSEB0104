      ...
      <div class="header_section">
         <div class="container-fluid">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
               <div class="logo"><a href="index.html"><img src="views/images/logo.png"></a></div>
      ...
      <div class="about_section layout_padding">
         <div class="container">
            <div class="row">
               ...
               <div class="col-md-6">
                  <div class="about_img"><img src="views/images/about-img.png"></div>
               </div>
            </div>
         </div>
      </div>
            ...
            <div class="">
                  ...
                  <div class="row">
                     <div class="col-md-4">
                        <div class="container_main">
                           <img src="views/images/img-1.png" alt="Avatar" class="image">
                           <div class="overlay">
                     ...
                     <div class="col-md-4">
                        <div class="container_main">
                           <img src="views/images/img-2.png" alt="Avatar" class="image">
                           <div class="overlay">
                              <div class="text"><a href="#"><i class="fa fa-search" aria-hidden="true"></i></a></div>
                           </div>
                        </div>
                     ...
                     <div class="col-md-4">
                        <div class="container_main">
                           <img src="views/images/img-3.png" alt="Avatar" class="image">
                           <div class="overlay">
                              <div class="text"><a href="#"><i class="fa fa-search" aria-hidden="true"></i></a></div>
                           </div>
                        </div>
               ...
               <div class="gallery_section_2">
                  <div class="row">
                     <div class="col-md-4">
                        <div class="container_main">
                           <img src="views/images/img-4.png" alt="Avatar" class="image">
                           <div class="overlay">
                              <div class="text"><a href="#"><i class="fa fa-search" aria-hidden="true"></i></a></div>
                           </div>
                        </div>
                     ...
                     <div class="col-md-4">
                        <div class="container_main">
                           <img src="views/images/img-5.png" alt="Avatar" class="image">
                           <div class="overlay">
                              <div class="overlay">
                                 <div class="text"><a href="#"><i class="fa fa-search" aria-hidden="true"></i></a></div>
                              </div>
                     ...
                     <div class="col-md-4">
                        <div class="container_main">
                           <img src="views/images/img-6.png" alt="Avatar" class="image">
                           <div class="overlay">
                              <div class="overlay">
                                 <div class="text"><a href="#"><i class="fa fa-search" aria-hidden="true"></i></a></div>
                              </div>
               ...
               <div class="gallery_section_2">
                  <div class="row">
                     <div class="col-md-4">
                        <div class="container_main">
                           <img src="views/images/img-7.png" alt="Avatar" class="image">
                           <div class="overlay">
                              <div class="text"><a href="#"><i class="fa fa-search" aria-hidden="true"></i></a></div>
                           </div>
                        </div>
                     ...
                     <div class="col-md-4">
                        <div class="container_main">
                           <img src="views/images/img-8.png" alt="Avatar" class="image">
                           <div class="overlay">
                              <div class="text"><a href="#"><i class="fa fa-search" aria-hidden="true"></i></a></div>
                           </div>
                        </div>
                     ...
                     <div class="col-md-4">
                        <div class="container_main">
                           <img src="views/images/img-9.png" alt="Avatar" class="image">
                           <div class="overlay">
                              <div class="text"><a href="#"><i class="fa fa-search" aria-hidden="true"></i></a></div>
                           </div>
                        </div>
            ...
            <div class="services_section_2">
               <div class="row">
                  <div class="col-lg-4 col-sm-12 col-md-4">
                     <div class="box_main active">
                        <div class="house_icon">
                           <img src="views/images/icon1.png" class="image_1">
                           <img src="views/images/icon1.png" class="image_2">
                        </div>
                  ...
                  <div class="col-lg-4 col-sm-12 col-md-4">
                     <div class="box_main">
                        <div class="house_icon">
                           <img src="views/images/icon2.png" class="image_1">
                           <img src="views/images/icon2.png" class="image_2">
                        </div>
                  ...
                  <div class="col-lg-4 col-sm-12 col-md-4">
                     <div class="box_main">
                        <div class="house_icon">
                           <img src="views/images/icon3.png" class="image_1">
                           <img src="views/images/icon3.png" class="image_2">
                        </div>
